...
const variantMap = {
  filled:
    "bg-primary-500 text-primary-100 shadow-[4px_4px_8px] shadow-primary-700/50 inset-shadow-[2px_2px_3px] inset-shadow-[#d3cbf1]/25 active:shadow-none active:inset-shadow-[1px_1px_4px] active:inset-shadow-secondary-900",
  tonal:
